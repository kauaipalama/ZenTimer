...
#ifndef PAPER_ONBOARDING_SWIFT_H
#define PAPER_ONBOARDING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="paper_onboarding",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC16paper_onboarding14GestureControl")
